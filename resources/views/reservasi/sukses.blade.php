    ...
    <div style="padding:28px 24px;text-align:center">
      ...
      <div style="margin:12px 0">
        <div id="kodeBox"
          ...
          {{ $reservasi->kode }}</div>
        <button id="salinBtn" onclick="salinKode('{{ $reservasi->kode }}')"
      ...
      {{-- ⚠️ BLOK PERINGATAN — ganåti/sisipkan setelah div kode+salin --}}
      <div style="
  margin: 16px 0 4px;
  ...
  ">
    ...
    ">&#9888;</span>
      ...
      <div style="display:flex;gap:8px;justify-content:center;flex-wrap:wrap;margin-top:20px">
        <a href="{{ route('cek.form') }}?kode={{ $reservasi->kode }}" class="btn btn-primary">Cek Status Reservasi</a>
