...
<div style="margin-top:calc(-1*(var(--th) + var(--bh)))">
  <section class="hero">
    ...
    <div class="hero-c">
      ...
      <div class="hero-cta">
        <a href="<?php echo e(route('reservasi.form')); ?>" class="btn btn-primary btn-lg">Buat Reservasi Kunjungan</a>
        <a href="<?php echo e(route('cek.form')); ?>" class="btn btn-secondary btn-lg">Cek Status Reservasi</a>
      </div>
      <div class="hero-stats">
        <div class="hst">
          <div class="hst-n" id="stTotal"><?php echo e($totalReservasi); ?></div>
          <div class="hst-l">Total Reservasi</div>
        </div>
        <div class="hst">
          <div class="hst-n" id="stDisetujui"><?php echo e($selesai); ?></div>
          <div class="hst-l">Selesai</div>
        </div>
        <div class="hst">
          <div class="hst-n" id="stOpd"><?php echo e($totalOpd); ?></div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/bellaaprilliaputriayu/Downloads/cb 1/resources/views/home/index.blade.php ENDPATH**/ ?>