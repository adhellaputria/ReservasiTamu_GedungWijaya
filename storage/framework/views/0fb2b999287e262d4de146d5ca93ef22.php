...
<head>
  <title><?php echo $__env->yieldContent('title','Dashboard'); ?> — SIJAMU Admin</title>
  <link rel="icon" type="image/png" href="<?php echo e(asset('images/logo-sukoharjo.png')); ?>">
<meta charset="UTF-8">
  ...
  <div class="topbar-brand">
      ...
      <div>
        ...
        <div class="topbar-sub">
          ...
          <?php else: ?>
            <?php echo e(session('admin_opd_nama','—')); ?>
    ...
    <div style="margin-left:auto;display:flex;align-items:center;gap:12px">
      <span style="font-size:.78rem;color:var(--blue-300)"><?php echo e(session('admin_nama')); ?></span>
...
<aside class="sidebar">
    <div style="padding:16px 0 40px">
      ...
      <a href="<?php echo e(route('admin.dashboard')); ?>" class="sl <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>"><span>&#9632;</span>Overview</a>
      <div class="sl-div"></div>
      
      <div class="sl-sec">Kelola Data</div>
      <a href="<?php echo e(route('admin.reservasi.index')); ?>" class="sl <?php echo e(request()->routeIs('admin.reservasi.index') ? 'active' : ''); ?>"><span>&#9632;</span>Semua Reservasi</a>
      <a href="<?php echo e(route('admin.ruangan.index')); ?>" class="sl <?php echo e(request()->routeIs('admin.ruangan.*') ? 'active' : ''); ?>"><span>&#9632;</span>Kelola Ruangan/OPD</a>
      <div class="sl-div"></div>
      
      <div class="sl-sec">Kelola Admin</div>
      <a href="<?php echo e(route('admin.opd-admin.index')); ?>" class="sl <?php echo e(request()->routeIs('admin.opd-admin.*') ? 'active' : ''); ?>"><span>&#9632;</span>Admin OPD</a>
      <div class="sl-div"></div>
      
      <div class="sl-sec">Laporan</div>
      <a href="<?php echo e(route('admin.laporan')); ?>" class="sl <?php echo e(request()->routeIs('admin.laporan*') ? 'active' : ''); ?>"><span>&#9632;</span>Laporan Global</a>
      
      <?php else: ?>
      
      <div class="sl-sec">Menu Utama</div>
      <a href="<?php echo e(route('admin.dashboard')); ?>" class="sl <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>"><span>&#9632;</span>Overview</a>
      <a href="<?php echo e(route('admin.reservasi.index')); ?>" class="sl <?php echo e(request()->routeIs('admin.reservasi.index') ? 'active' : ''); ?>"><span>&#9632;</span>Reservasi Tamu</a>
      <div class="sl-div"></div>
      <div class="sl-sec">Petugas</div>
      <a href="<?php echo e(route('admin.verifikasi.index')); ?>" class="sl <?php echo e(request()->routeIs('admin.verifikasi.*') ? 'active' : ''); ?>"><span>&#9632;</span>Verifikasi Kehadiran</a>
      <div class="sl-div"></div>
      <div class="sl-sec">Laporan</div>
      <a href="<?php echo e(route('admin.laporan')); ?>" class="sl <?php echo e(request()->routeIs('admin.laporan*') ? 'active' : ''); ?>"><span>&#9632;</span>Laporan OPD</a>
      <?php endif; ?>
      ...
      <div style="padding:12px 18px">
        <div style="background:rgba(255,255,255,.07);border-radius:var(--r-sm);padding:10px 12px">
          ...
          <div style="font-size:.82rem;font-weight:600;color:var(--white)"><?php echo e(session('admin_nama')); ?></div>
  ...
  <main class="dash-main">
    ...
    <div class="flash">
      <div class="alert alert-ok"><span class="ai">✓</span><?php echo e(session('success')); ?></div>
    </div>
    <?php endif; ?>
    <?php if(session('error')): ?>
    <div class="flash">
      <div class="alert alert-err"><span class="ai">✕</span><?php echo e(session('error')); ?></div>
    </div>
    <?php endif; ?>
...
<?php /**PATH /Users/bellaaprilliaputriayu/Downloads/cb 1/resources/views/layouts/admin.blade.php ENDPATH**/ ?>