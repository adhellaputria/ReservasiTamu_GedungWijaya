...
<div class="card">
  <div class="hdr">
    <div class="logo">
      <img src="<?php echo e(asset('images/logo-sukoharjo.png')); ?>" width="32">
  </div>
  ...
  <div class="body">
    <?php if($errors->has('login')): ?>
      <div class="alert"><span>✕</span><?php echo e($errors->first('login')); ?></div>
    <?php endif; ?>
    <?php if(session('success')): ?>
      <div style="padding:10px 14px;border-radius:4px;border-left:4px solid #22c55e;background:#f0fdf4;color:#14532d;font-size:.83rem;margin-bottom:14px;display:flex;align-items:center;gap:9px"><span>✓</span><?php echo e(session('success')); ?></div>
    <?php endif; ?>
    <form action="<?php echo e(route('admin.login.post')); ?>" method="POST">
      <?php echo csrf_field(); ?>
      <div class="form-group">
        <label class="form-label">Username</label>
        <input type="text" name="username" class="fc" placeholder="Username admin" value="<?php echo e(old('username')); ?>" autocomplete="username" autofocus>
      </div>
      <div class="form-group">
  ...
  <div class="ftr"><a href="<?php echo e(route('home')); ?>" style="color:var(--blue-600)">&larr; Kembali ke Beranda</a></div>
</div>
</body>
</html>
<?php /**PATH /Users/bellaaprilliaputriayu/Downloads/cb 1/resources/views/admin/login.blade.php ENDPATH**/ ?>